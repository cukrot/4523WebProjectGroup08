...
$translations = [
    'en' => [
        ...
        'report_title' => 'Sales and Material Report',
        ...
        'error_invalid_date' => 'Please select a valid date range.',
    ...
    'zh' => [
        ...
        'summary' => '總結',
        'total_orders' => '總訂單數',
        'total_sales_amount' => '總銷售金額',
        'products_summary' => '產品統計',
        'materials_summary' => '材料統計',
        'total_quantity' => '總數量',
        'no_products_found' => '未找到產品。',
        'no_materials_found' => '未找到材料。',
        'error_invalid_date' => '請選擇有效的日期範圍。',
        'material_id' => '材料編號',
